    ...
    <div className=" py-10 w-full h-full ">
       ...
       <div className="lg:px-0 px-8  flex lg:flex-row flex-col pb-14 gap-8  lg:mx-[25%]">
          ...
          <div className="">
             ...
             <Link to="/" className=" "> <button className="bg-[#800080] relative text-white shadow-lg shadow-[#4c4848]  w-[261px] h-[54px]  rounded-lg text-[22px] font-semibold font-font1">Purchase Now </button></Link>
       ...
       <div className="text-white text-center ">
        ...
        <Link to="" className="relative"><button className= " items-center bg-[#800080] text-center shadow-lg shadow-black-500 text-white lg:w-[377px] w-[230px] lg:h-[54px] h-[46px] border-yellow rounded-[50px] lg:text-[22px] text-sm font-semibold font-font1  lg:mt-14 mt-10 lg:mb-0 mb-10">Purchase Now</button></Link>
       </div>
    </div>
    </div>
  )
