...
const NavBar = () => {
  ...
  return (
    <nav  className={`  bg-[#310080]    w-full h-[88px]  flex justify-between lg:px-20 px-8 py-12 text-[#FFFFFF] text-xl items-center `}>
        <div className='py-6 '>
        ...
        <ul  className={` flex lg:flex-row md:flex-col flex-col bg-[#310080]  items-center justify-center px-4 py-6 md:z-50 z-50 lg:static  md:absolute absolute  right-0 lg:w-auto md:w-full w-full   text-[22px]
         md:pb-0 pb-12   md:opacity-100 transition-all ease-in duration-500 ${open ? 'top-20' : 'top-[-490px]'} `}>
           ...
           <Link to="/about-us"> <li className='font-normal px-4 lg:pb-0 md:pb-6 pb-6 hover:font-bold  text-center' >About Us</li></Link>
