...
const Contact = () => {
  return (
    <div className="text-white bg-white lg:px-20 px-8 py-8 ">
        ...
        <div className="p-3 border-4 rounded-xl shadow-inner shadow-[#6e6969] flex  ">
           <div className="text-white bg-[#250325] pt-10 px-10 lg:h-[647px] lg:w-[500px] border rounded-lg font-font1">
             ...
             <form action="" className="pt-10 px-20">
                ...
                <button className= "bg-[#800080] text-center shadow-lg shadow-[#4c4848] text-[#FFFFFF] w-[224px] h-[56px] border-[#800080] rounded-lg text-[22px] font-semibold font-font1 items-center lg:mx-[40%] mt-10">Send Message </button>
             </form>
